package com.neerajmohinani.projects.core;

/**
 * Project constants
 */
public final class ProjectConstant {
    public static final String BASE_PACKAGE = "com.neerajmohinani.projects";// project-based package name, modified according to the company's own project
